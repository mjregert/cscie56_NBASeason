...
<html>
    ...
    <body>
        ...
        <div id="show-season" class="content scaffold-show" role="main">
            ...
            <f:display bean="season" />
            <g:form resource="${this.season}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.season}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
